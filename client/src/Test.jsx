...
}; //linkify-react for links in the texts 


const Test = () => {
    const { authUser } = useAuthStore();
    const { messages, selectedUser, ismessloading, blockUser, getusers, getBlockedUsers, pinnedChats, pinChat, unpinChat, getPinnedChats, sendMessageRequest, isUserAccepted, listenMessage } = messAuth();
                                    ...
                                    {messages.map((msg) => {
                                        ...
                                        return (
                                            <div key={msg._id} className={`flex ${isSender ? "justify-end" : "justify-start"}`}>
                                                ...
                                                >
                                                    {msg.text && (
                                                        <p className="p-3 text-sm"><MessageText text={msg.text} /></p>
